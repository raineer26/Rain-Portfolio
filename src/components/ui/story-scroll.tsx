...
export const FlowSection: React.FC<FlowSectionProps> = ({ className, style = {}, children }) => (
  <section data-flow-section className={cx("relative min-h-screen w-full overflow-hidden", className)}>
    <div
      data-flow-inner
      className={cx(
...
export const FlowArt: React.FC<FlowArtProps> = ({ children, className }) => {
  ...
  return (
    <main ref={containerRef} className={cx("w-full overflow-x-hidden", className)}>
      {children}
    </main>
  );
};
