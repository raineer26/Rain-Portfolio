              ...
              <div className="flex flex-col items-center md:items-start gap-6">
                <div>
                  ...
                  <p className="mt-3 text-muted-foreground text-sm sm:text-base max-w-md text-center md:text-left leading-relaxed">
                    Digital illustrator and visual designer — crafting characters, logos, and immersive creative experiences.
                  </p>
                </div>
                ...
                <div ref={linksRef} className="flex flex-col items-center md:items-start gap-4 w-full">
                  ...
                  <div className="flex flex-wrap justify-center md:justify-start gap-3 mt-2">
                    ...
                    <MagneticButton as="a" href="https://www.linkedin.com/in/raineer-rosado-390a1b412" target="_blank" rel="noopener noreferrer" className="footer-glass-pill px-5 py-2.5 rounded-full text-muted-foreground font-medium text-xs md:text-sm hover:text-foreground">
                      LinkedIn
                    </MagneticButton>
